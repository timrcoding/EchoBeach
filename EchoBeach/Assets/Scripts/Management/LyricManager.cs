...
{
    public static LyricManager instance;
    public event Action BeatCalled;
    ...
    public class TimelineInfo
    {
       ...
       // public event Func<string> LyricsDelegate;

        public void PrintString()
    {
         SongManager.instance.SetLyrics((string)lastMarker);
    }
